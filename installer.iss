...
[Tasks]
Name: "desktopicon"; Description: "Desktopsymbol erstellen"; GroupDescription: "Zus�tzliche Symbole:"; Flags: unchecked
...
begin
  ...
  KeepSettings := MsgBox(
    ...
    + Chr(13)
    + 'Nein - Alles wird gel�scht inklusive Datenbank und Logdateien',
